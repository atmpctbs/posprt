# f403ddcc-cdb6-482e-979b-7aa4ea43b1de implementation handoff

This archive is the source of truth for turning the design into production code. Start from `POS Payment Screen v2.dc.html`, then preserve the visual system, responsive behavior, and interactions found in the exported files.
...
- A single self-contained `POS Payment Screen v2.dc.html` is acceptable only when the export truly contains one user-facing screen and its CSS/JS are structured enough to extract tokens, components, states, and behavior.
...
1. Open `POS Payment Screen v2.dc.html` and `DESIGN-MANIFEST.json`; identify every screen file, launcher/overview file, app module, and interaction before coding.
...
## Entry points
- `POS Payment Screen v2.dc.html`
- `POS Terminal Empleado.dc.html`
...
- `_source/Physical-POS-payment-screen-3.zip`
- `assets/alipay.png`
- `assets/bizum.png`
- `assets/campaigns/aula.jpg`
- `assets/campaigns/CREDITS.json`
- `assets/campaigns/CREDITS.md`
- `assets/campaigns/infancia.jpg`
- `assets/campaigns/investigacion.jpg`
- `assets/nfc.svg`
- `assets/paypal.png`
...
- `thumbnail.jpg`
- `uploads/menu-grid-r-svgrepo-com-acb66962.svg`
- `uploads/menu-grid-r-svgrepo-com.svg`
- `uploads/pasted-1788983913981-0.png`
- `uploads/pasted-1788984096867-0.png`
- `uploads/pasted-1788986311335-0.png`
- `uploads/pasted-1788986393111-0.png`
- `uploads/pasted-1789319124131-0.png`

## Coding checklist for AI tools
1. Inspect `POS Payment Screen v2.dc.html` and `DESIGN-MANIFEST.json` first and identify reusable components before coding.
